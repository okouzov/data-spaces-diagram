...
export const nodeBlueprints = {
  ...
  identity: { icon: "key", x: 13, y: 20 },
  policy: { icon: "handshake", x: 87, y: 20 },
...
export const copy = {
  en: {
    ...
    nodes: {
      ...
      exchange: { label: "Secure Exchange", subtitle: "connector to connector", note: "( outside the Data Space! )" },
  ...
  bg: {
    ...
    nodes: {
      ...
      exchange: { label: "Сигурен обмен", subtitle: "конектор към конектор", note: "( извън пространството за данни! )" },
